...
const EducationTile = ({
  ...
  <div className="font-poppins bg-slate-300 dark:bg-gray-800 shadow-md rounded-xl px-8 py-6 my-6 w-full max-w-3xl mx-auto">
    ...
    <h3 className="text-sm mt-4 font-semibold text-gray-800 dark:text-gray-200">
      Relevant Coursework:{" "}
    
    <span className="font-light text-sm list-disc list-inside text-gray-700 dark:text-gray-300">
